<div>
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Welcome to the <br><span class="text-blue-600">E-commerce Website </span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">This website is an online shopping platform that offers a wide range of products to meet your daily needs. From fashion, electronics, household goods, to other unique items, we provide a simple, fast, and secure shopping experience..</p>
        ...
        <div class="max-w-xl mx-auto">
          <div class="text-center">
            ...
            <p class="mb-12 text-base text-center text-gray-500">
              Explore top brands trusted by millions. From the latest tech to everyday essentials, find high-quality products from names you know and love — all in one place.
            </p>
          </div>
        </div>
  ...
  <div class="text-center">
    ...
    <p class="mb-12 text-base text-center text-gray-500">
      Find what you’re looking for faster by exploring our product categories. Whether you're shopping for fashion, gadgets, home essentials, or gifts — everything is just a click away.
    </p>
  </div>
</div>
        ...
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center">
              ...
              <p class="mb-12 text-base text-center text-gray-500">
                Hear what our happy customers have to say about their experience! We’re proud to deliver top-quality products, fast service, and exceptional support that keeps our users coming back.
              </p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                ...
                <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 12, FEB , 2025
                </p>
              </div>
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                Using Laravel as the main framework, this website features clean, secure, and maintainable code architecture. Laravel's built-in features such as authentication, validation, and database management significantly accelerate the development process.
              </p>
            ...
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                Filament is utilized to create an intuitive admin dashboard, simplifying the management of products, categories, and orders. With Filament, CRUD operations are faster and more visual, allowing the admin to monitor store activities in real-time
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
            ...
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                Livewire enables this website to have interactive features without the need to write JavaScript manually. Features like product search, category filtering, and checkout processes run smoothly and responsively, providing a seamless user experience.
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
            ...
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                ...
                <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 19, SEP , 2024
                </p>
              </div>
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                The website is designed to be accessible across various devices, from desktops to smartphones, ensuring customers can shop anytime and anywhere.
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
