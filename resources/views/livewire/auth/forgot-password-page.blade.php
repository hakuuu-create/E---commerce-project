          ...
          <div class="p-4 sm:p-7">
            ...
            <div class="mt-5"> 
              ...
              <form wire:submit.prevent='save'>
                @if (session('success'))
                <div class="mb-4 mt-2 bg-green-100 border border-green-200 text-sm text-white-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500" role="alert" tabindex="-1" aria-labelledby="hs-soft-color-danger-label">
                  {{ session('success') }}
                </div>
                @endif
